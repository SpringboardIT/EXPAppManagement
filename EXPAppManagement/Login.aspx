<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EXPAppManagement.Login" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <title>Kindred App Management</title>
            ...
            <div style="margin-bottom: 10px">
               <div>
                  <asp:Button runat="server" OnClick="SignIn" Text="Log in" />
                         ...
                         <div style="margin-bottom: 10px">
               <div>
                  <asp:Button runat="server" OnClick="ForgotPassword" Text="Forgot Password" />
               </div>
            </div>
         </asp:PlaceHolder>
