<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="EXPAppManagement.ForgotPassword" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
 ...
 <form id="form1" class="login-form bg-white p-6 mx-auto border bd-default win-shadow" runat="server">
      ...
      <div>
         ...
         <asp:PlaceHolder runat="server" ID="LoginForm" Visible="false">
            ...
            <div style="margin-bottom: 10px">
               <div>
                  <asp:Button runat="server" OnClick="SignIn" Text="Request Reset Password" />
               </div>
            </div>
         </asp:PlaceHolder>
